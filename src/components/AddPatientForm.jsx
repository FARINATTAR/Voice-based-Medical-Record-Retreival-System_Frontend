        ...
        <div className="p-6">
          ...
          {existingPatient && (
            <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <h4 className="font-semibold text-lg mb-3 text-purple-800">Patient Found!</h4>
              <div className="space-y-2 mb-4">
                <p className="text-gray-700"><strong>Name:</strong> {existingPatient.name}</p>
                <p className="text-gray-700"><strong>Email:</strong> {existingPatient.email}</p>
                <p className="text-gray-700"><strong>Phone:</strong> {existingPatient.phone}</p>
                <p className="text-gray-700"><strong>Age:</strong> {existingPatient.age} | <strong>Gender:</strong> {existingPatient.gender}</p>
              </div>

              <button
                onClick={handleLinkPatient}
                disabled={loading}
                className="mt-4 w-full bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 disabled:bg-purple-300 disabled:cursor-not-allowed transition-all font-medium"
              >
                {loading ? 'Linking...' : 'Link Patient to Hospital'}
              </button>
            </div>
          ...
          {!existingPatient && (
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                    />
                    <button
                      type="button"
              ...
              <div className="border-t pt-4 mt-4">
                <h4 className="font-semibold mb-3 text-gray-800">Emergency Contact</h4>
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Contact Name
              ...
              <div className="flex space-x-4 pt-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:bg-purple-300 disabled:cursor-not-allowed transition-all font-medium"
                >
                  {loading ? 'Adding...' : 'Add Patient'}
                </button>
              </div>
